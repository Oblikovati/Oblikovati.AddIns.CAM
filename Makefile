# Build the oblikovati-cam add-in as a c-shared library (.so/.dll/.dylib) and install
# it into the host's add-ins directory, which the host scans at startup.
#
