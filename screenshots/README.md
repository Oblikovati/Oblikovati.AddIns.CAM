...
| `sim-path-overlay.png` | The simulator's playback overlay as it appears in the viewport: an isometric backplot of the toolpath with cutting moves green and rapids blue — here a zig-zag pocket's green floor passes linked by blue rapids up at the clearance plane. |
