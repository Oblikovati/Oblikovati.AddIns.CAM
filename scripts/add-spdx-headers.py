...
This is the oblikovati-cam add-in (module oblikovati.org/cam), GPL-2.0-only
throughout. The SHIPPED c-shared library links only the Apache-2.0 contract
(oblikovati.org/api); the GPL application module (oblikovati.org) is pulled in
solely by the add-in<->host integration tests. The repo is GPL-2.0-only
