...
func shots() []shot {
	return []shot{
		...
		{"pocket-zigzag", &bridge.PocketOp{OpBase: millEnv("Pocket"), StepOver: 0.6, Pattern: gen.PocketZigzag, Boundary: squarePoly(40)}},
		{"pocket-zigzag-oneway", &bridge.PocketOp{OpBase: millEnv("Pocket"), StepOver: 0.6, Pattern: gen.PocketZigzag, OneWay: true, Boundary: squarePoly(40)}},
		...
		{"chamfer-multipass", &bridge.ChamferOp{OpBase: millEnv("Chamfer"), Width: 4, ToolAngle: 90, Side: gen.SideOutside, Climb: true, Passes: 4, Boundary: part()}},
		{"vcarve", &bridge.VCarveOp{OpBase: millEnv("V-Carve"), ToolAngle: 90, Boundary: part()}},
