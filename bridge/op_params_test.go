...
func TestEveryOpIsEditable(t *testing.T) {
	ops := []Operation{
		&DrillingOp{}, &ProfileOp{}, &PocketOp{}, &AdaptiveOp{}, &RestOp{}, &TrochoidalOp{}, &SlotOp{}, &MillFaceOp{}, &EngraveOp{}, &ChamferOp{}, &VCarveOp{}, &HelixOp{}, &ThreadMillOp{}, &CounterboreOp{}, &CountersinkOp{}, &ProbeOp{}, &ToolLengthProbeOp{}, &SurfaceOp{}, &WaterlineOp{},
	}
	for _, op := range ops {
		ed, ok := op.(Editable)
		if !ok {
