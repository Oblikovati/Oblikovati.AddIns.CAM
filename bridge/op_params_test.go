...
func TestEveryOpIsEditable(t *testing.T) {
	ops := []Operation{
		&DrillingOp{}, &ProfileOp{}, &PocketOp{}, &AdaptiveOp{}, &RestOp{}, &TrochoidalOp{}, &SlotOp{}, &MillFaceOp{}, &EngraveOp{}, &ChamferOp{}, &VCarveOp{}, &HelixOp{}, &ThreadMillOp{}, &CounterboreOp{}, &TappingOp{}, &CountersinkOp{}, &ProbeOp{}, &ToolLengthProbeOp{}, &SurfaceOp{}, &WaterlineOp{}, &CustomOp{},
	}
	for _, op := range ops {
		ed, ok := op.(Editable)
		if !ok {
