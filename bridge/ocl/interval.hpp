...
#include <set>      // [oblikovati] was transitively via halfedgediagram.hpp
#include <utility> // [oblikovati] std::pair
// [oblikovati] dropped boost/graph (weave-only); WeaveVertex stubbed to void* below
...
class Interval {
    public:
        ...
        typedef void* WeaveVertex; // [oblikovati] was boost::adjacency_list_traits<...>::vertex_descriptor
